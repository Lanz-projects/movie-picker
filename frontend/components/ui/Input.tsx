    ...
    return (
      <div className="relative w-full">
        ...
        <input
          ref={ref}
          className={cn(
            "w-full rounded-xl bg-bg-surface border border-border-subtle text-text-main placeholder:text-text-muted px-4 py-2.5 text-sm font-sans transition-all duration-200",
